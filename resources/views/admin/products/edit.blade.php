...
<div class="bg-white rounded-2xl shadow-md p-6 max-w-4xl mx-auto border border-[#e0e8d5]">
    ...
    <h1 class="text-2xl font-bold text-[#3a5e1e] mb-6">Editar Producto</h1>
    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="w-full border border-[#e0e8d5] rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5c8b2d]">{{ $product->description }}</textarea>
        </div>
