<x-app-layout>
  <div class="min-h-screen flex items-center justify-center bg-[#f6fbee] px-4">
    <form action="{{ route('star-session') }}" method="POST" class="bg-white shadow-md rounded-2xl px-10 pt-8 pb-10 w-full max-w-md border border-[#84976d]">
      @csrf
      ...
      <button type="submit" class="w-full bg-[#5c8b2d] text-white font-semibold py-2 rounded-xl hover:bg-[#4a7124] transition duration-300">Acceder</button>
    </form>
  </div>
</x-app-layout>
